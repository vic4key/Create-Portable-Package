...
def main(argc, argv):
  ...
  parser.add_argument("-e", "--exclusion-file", type=str, required=False, default="exclusion.txt", help="The exclusion file")
  ...
  pp.create_portable_package(args.package_directory, args.exclusion_file, args.clean_up)
